...
const NeobrutalCard: React.FC<NeobrutalCardProps> = ({
  ...
  return (
    <div
      className={`relative border-4 border-black ${rounded} ${padding} w-full max-w-4xl flex flex-col items-center justify-between font-extrabold text-black bg-white shadow-[8px_8px_0_0_#000] hover:shadow-[6px_6px_0_0_#000] transition-transform duration-200 ease-in-out ${className}`}
      style={style}
      onClick={onClick}
    >
      {/* Accent corner */}
